...
import com.techscl.ichat.activity.AlertDialog;
import com.techscl.ichat.activity.BaiduMapActivity;
import com.techscl.ichat.activity.ChatActivity;
import com.techscl.ichat.activity.ContextMenu;
import com.techscl.ichat.activity.ShowBigImage;
import com.techscl.ichat.activity.ShowNormalFileActivity;
import com.techscl.ichat.activity.ShowVideoActivity;
...
import com.techscl.ichat.task.LoadImageTask;
import com.techscl.ichat.task.LoadVideoImageTask;
import com.techscl.ichat.utils.DateUtils;
import com.techscl.ichat.utils.ImageCache;
import com.techscl.ichat.utils.ImageUtils;
                        ...
                        activity.runOnUiThread(new Runnable() {
                            public void run() {
                                ...
                                if (message.status == EMMessage.Status.SUCCESS) {
                                    ...
                                    holder.staus_iv.setVisibility(View.VISIBLE);
                                    To.show(activity.getString(R.string.send_fail) + activity.getString(R.string.connect_failuer_toast));
                                    timer.cancel();
                                }
            ...
            public void run() {
                ...
                if (message.status == EMMessage.Status.SUCCESS) {
                    ...
                    if (message.getError() == EMError.MESSAGE_SEND_INVALID_CONTENT) {
                        To.show(activity.getString(R.string.send_fail) + activity.getString(R.string.error_send_invalid_content));
                    } else if (message.getError() == EMError.MESSAGE_SEND_NOT_IN_THE_GROUP) {
                        To.show(activity.getString(R.string.send_fail) + activity.getString(R.string.error_send_not_in_the_group));
                    } else {
                        To.show(activity.getString(R.string.send_fail) + activity.getString(R.string.connect_failuer_toast));
                    }
                }
