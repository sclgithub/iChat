...
import com.techscl.ichat.fragment.ChatAllHistoryFragment;
...
//					unreadAddressLable.setText(String.valueOf(count));
    ...
    private void showConflictDialog() {
        ...
        if (!MainActivity.this.isFinishing()) {
            ...
            try {
                ...
                L.e("---------color conflictBuilder error" + e.getMessage());
            }
    ...
    private void showAccountRemovedDialog() {
        ...
        if (!MainActivity.this.isFinishing()) {
            ...
            try {
                ...
                L.e("---------color userRemovedBuilder error" + e.getMessage());
            }
    ...
    public class MyContactListener implements EMContactListener {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    if (ChatActivity.activityInstance != null
                        ...
                        To.show(ChatActivity.activityInstance.getToChatUsername() + st10);
        ...
        public void onContactInvited(String username, String reason) {
            ...
            L.d(username + "请求加你为好友,reason: " + reason);
            // 设置相应status
