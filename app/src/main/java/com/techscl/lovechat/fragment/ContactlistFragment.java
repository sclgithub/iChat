...
import com.techscl.applib.controller.HXSDKHelper.HXSyncListener;
import com.techscl.lovechat.Constant;
import com.techscl.lovechat.DemoHXSDKHelper;
import com.techscl.lovechat.activity.AddContactActivity;
import com.techscl.lovechat.activity.ChatActivity;
import com.techscl.lovechat.activity.GroupsActivity;
import com.techscl.lovechat.activity.MainActivity;
import com.techscl.lovechat.activity.NewFriendsMsgActivity;
import com.techscl.lovechat.activity.PublicChatRoomsActivity;
import com.techscl.lovechat.activity.RobotsActivity;
...
public class ContactlistFragment extends Fragment {
    ...
    class HXContactSyncListener implements HXSDKHelper.HXSyncListener {
        ...
        public void onSyncSucess(final boolean success) {
            L.d("on contact list sync success:" + success);
    ...
    class HXContactInfoSyncListener implements HXSDKHelper.HXSyncListener {
        ...
        @Override
        public void onSyncSucess(final boolean success) {
            L.d("on contactinfo list sync success:" + success);
            getActivity().runOnUiThread(new Runnable() {
